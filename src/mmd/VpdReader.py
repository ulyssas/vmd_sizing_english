...
class VpdReader:
    ...
    def read_model_name(self):
        ...
        with open(
            self.file_path, "r", encoding=self.get_file_encoding(self.file_path)
        ) as f:
            lines = f.readlines()
    ...
    def read_data(self):
        ...
        try:
            ...
            model_name_pattern = re.compile(
                r"(.*)(?:\.osm;)(?:.*// 親ファイル名.*)", flags=re.IGNORECASE
            )
