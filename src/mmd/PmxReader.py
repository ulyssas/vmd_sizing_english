...
class PmxReader:
    ...
    def read_model_name(self):
        ...
        with open(self.file_path, "rb") as f:
            ...
            self.read_vertex_index_size = self.define_read_vertex_idx(
                ...
                if self.is_sizing:
                    ...
                    if "右足先EX" in pmx.bones or "右足ＩＫ" in pmx.bones:
                        ...
                        if "右足先EX" in pmx.bones:
                            right_sole_vertex = Vertex(
                                -1,
                                MVector3D(
                                    pmx.bones["右足先EX"].position.x(),
                                    0,
                                    pmx.bones["右足先EX"].position.z(),
                                ),
                                MVector3D(),
                                MVector2D(),
                                [],
                        ...
                        if right_sole_vertex:
                            ...
                            if "右足先EX" in pmx.bones:
                                right_sole_bone.parent_index = pmx.bones[
                                    "右足先EX"
                                ].index
                            ...
                            pmx.bone_indexes[right_sole_bone.index] = (
                                right_sole_bone.name
                            )
                    ...
                    if "左足先EX" in pmx.bones or "左足ＩＫ" in pmx.bones:
                        ...
                        if "左足先EX" in pmx.bones:
                            left_sole_vertex = Vertex(
                                -1,
                                MVector3D(
                                    pmx.bones["左足先EX"].position.x(),
                                    0,
                                    pmx.bones["左足先EX"].position.z(),
                                ),
                                MVector3D(),
                                MVector2D(),
                                [],
                        ...
                        if left_sole_vertex:
                            ...
                            left_sole_bone = Bone(
                                "左足底実体",
                                "left sole entity",
                                left_sole_vertex.position.copy(),
                                -1,
                                0,
                                0,
                                is_sizing=True,
                            ...
                            if "左足先EX" in pmx.bones:
                                left_sole_bone.parent_index = pmx.bones[
                                    "左足先EX"
                                ].index
                    ...
                    if "右足ＩＫ" in pmx.bones or "右つま先ＩＫ" in pmx.bones:
                        ...
                        if right_toe_vertex:
                            ...
                            if "右足底実体" in pmx.bones:
                                right_toe_bone.parent_index = pmx.bones[
                                    "右足底実体"
                                ].index
                    ...
                    if "左足ＩＫ" in pmx.bones or "左つま先ＩＫ" in pmx.bones:
                        ...
                        if left_toe_vertex:
                            ...
                            if "左足底実体" in pmx.bones:
                                left_toe_bone.parent_index = pmx.bones[
                                    "左足底実体"
                                ].index
                    ...
                    if "左肩" in pmx.bones and "右肩" in pmx.bones:
                        neck_base_vertex = Vertex(
                            -1,
                            (pmx.bones["左肩"].position + pmx.bones["右肩"].position)
                            / 2,
                            MVector3D(),
                            MVector2D(),
                            [],
                        ...
                        neck_base_bone = Bone(
                            "首根元",
                            "base of neck",
                            neck_base_vertex.position.copy(),
                            -1,
                            0,
                            0,
                            is_sizing=True,
                    ...
                    if "左腕" in pmx.bones and "右腕" in pmx.bones:
                        neck_base2_vertex = Vertex(
                            -1,
                            (pmx.bones["左腕"].position + pmx.bones["右腕"].position)
                            / 2,
                            MVector3D(),
                            MVector2D(),
                            [],
                        ...
                        neck_base2_bone = Bone(
                            "首根元2",
                            "base of neck",
                            neck_base2_vertex.position.copy(),
                            -1,
                            0,
                            0,
                            is_sizing=True,
                    ...
                    if "右肩" in pmx.bones:
                        ...
                        pmx.bones[right_shoulder_under_bone.name] = (
                            right_shoulder_under_bone
                        )
                        pmx.bone_indexes[right_shoulder_under_bone.index] = (
                            right_shoulder_under_bone.name
                        )
                    ...
                    if "左肩" in pmx.bones:
                        ...
                        pmx.bones[left_shoulder_under_bone.name] = (
                            left_shoulder_under_bone
                        )
                        pmx.bone_indexes[left_shoulder_under_bone.index] = (
                            left_shoulder_under_bone.name
                        )

                    if "右ひじ" in pmx.bones and "右腕" in pmx.bones:
                        # 右腕ひじ中間ボーン
                        right_arm_middle_pos = (
                            pmx.bones["右ひじ"].position + pmx.bones["右腕"].position
                        ) / 2
                        right_arm_middle_bone = Bone(
                            "右腕ひじ中間",
                            "",
                            right_arm_middle_pos,
                            -1,
                        ...
                        pmx.bone_indexes[right_arm_middle_bone.index] = (
                            right_arm_middle_bone.name
                        )

                        if "右腕捩" in pmx.bones:
                            right_arm_middle_bone.parent_index = pmx.bones[
                                "右腕捩"
                            ].index
                    ...
                    if "左ひじ" in pmx.bones and "左腕" in pmx.bones:
                        # 左腕ひじ中間ボーン
                        left_arm_middle_pos = (
                            pmx.bones["左ひじ"].position + pmx.bones["左腕"].position
                        ) / 2
                        left_arm_middle_bone = Bone(
                            "左腕ひじ中間",
                            "",
                            left_arm_middle_pos,
                            -1,
                        ...
                        pmx.bone_indexes[left_arm_middle_bone.index] = (
                            left_arm_middle_bone.name
                        )

                        if "左腕捩" in pmx.bones:
                            left_arm_middle_bone.parent_index = pmx.bones[
                                "左腕捩"
                            ].index
                    ...
                    if "右ひじ" in pmx.bones and "右手首" in pmx.bones:
                        # 右ひじ手首中間ボーン
                        right_elbow_middle_pos = (
                            pmx.bones["右ひじ"].position + pmx.bones["右手首"].position
                        ) / 2
                        right_elbow_middle_bone = Bone(
                            "右ひじ手首中間",
                            "",
                            right_elbow_middle_pos,
                            -1,
                        ...
                        pmx.bones[right_elbow_middle_bone.name] = (
                            right_elbow_middle_bone
                        )
                        pmx.bone_indexes[right_elbow_middle_bone.index] = (
                            right_elbow_middle_bone.name
                        )

                        if "右手捩" in pmx.bones:
                            right_elbow_middle_bone.parent_index = pmx.bones[
                                "右手捩"
                            ].index
                    ...
                    if "左ひじ" in pmx.bones and "左手首" in pmx.bones:
                        # 左ひじ手首中間ボーン
                        left_elbow_middle_pos = (
                            pmx.bones["左ひじ"].position + pmx.bones["左手首"].position
                        ) / 2
                        left_elbow_middle_bone = Bone(
                            "左ひじ手首中間",
                            "",
                            left_elbow_middle_pos,
                            -1,
                        ...
                        pmx.bone_indexes[left_elbow_middle_bone.index] = (
                            left_elbow_middle_bone.name
                        )

                        if "左手捩" in pmx.bones:
                            left_elbow_middle_bone.parent_index = pmx.bones[
                                "左手捩"
                            ].index
                    ...
                    if "右つま先" in pmx.bones or "右つま先ＩＫ" in pmx.bones:
                        toe_bone_name = (
                            ...
                            else pmx.bone_indexes[
                                pmx.bones["右つま先ＩＫ"].ik.target_index
                            ]
                        )
                        ...
                        pmx.bone_indexes[right_big_toe_bone.index] = (
                            right_big_toe_bone.name
                        )
                        ...
                        right_small_toe_bone.parent_index = pmx.bones[
                            toe_bone_name
                        ].index
                        right_small_toe_bone.index = len(pmx.bones.keys())
                        pmx.bones[right_small_toe_bone.name] = right_small_toe_bone
                        pmx.bone_indexes[right_small_toe_bone.index] = (
                            right_small_toe_bone.name
                        )
                    ...
                    if "右足首" in pmx.bones:
                        right_heel_bone = Bone(
                            ...
                            "",
                            MVector3D(
                                pmx.bones["右足首"].position.x(),
                                0,
                                pmx.bones["右足首"].position.z(),
                            ),
                            -1,
                            0,
                            0,
                    ...
                    if "左つま先" in pmx.bones or "左つま先ＩＫ" in pmx.bones:
                        toe_bone_name = (
                            ...
                            if "左つま先" in pmx.bones
                                ...
                                pmx.bones["左つま先ＩＫ"].ik.target_index
                            ]
                        )
                        ...
                        pmx.bone_indexes[left_big_toe_bone.index] = (
                            left_big_toe_bone.name
                        )
                        ...
                        left_small_toe_bone.parent_index = pmx.bones[
                            toe_bone_name
                        ].index
                        left_small_toe_bone.index = len(pmx.bones.keys())
                        pmx.bones[left_small_toe_bone.name] = left_small_toe_bone
                        pmx.bone_indexes[left_small_toe_bone.index] = (
                            left_small_toe_bone.name
                        )
                    ...
                    if "左足首" in pmx.bones:
                        left_heel_bone = Bone(
                            ...
                            "",
                            MVector3D(
                                pmx.bones["左足首"].position.x(),
                                0,
                                pmx.bones["左足首"].position.z(),
                            ),
                            -1,
                            0,
                            0,
                    ...
                    for direction in ["左", "右"]:
                        for finger_name, end_joint_name in [
                            ...
                            end_joint_name = "{0}{1}{2}".format(
                                direction, finger_name, end_joint_name
                            )

                            if end_joint_name not in pmx.bones:
                                continue

                            to_joint_name = "{0}{1}{2}".format(
                                direction, finger_name, "先実体"
                            )

                            finger_tail_vertex = pmx.get_finger_tail_vertex(
                                end_joint_name, to_joint_name
                            )
                            if finger_tail_vertex:
                                pmx.finger_tail_vertex = finger_tail_vertex
                                finger_tail_pos = finger_tail_vertex.position.copy()
                                finger_tail_bone = Bone(
                                    to_joint_name,
                                    "",
                                    finger_tail_pos,
                                    -1,
                    ...
                    if "左足" in pmx.bones and "右足" in pmx.bones:
                        leg_center_vertex = Vertex(
                            -1,
                            (pmx.bones["左足"].position + pmx.bones["右足"].position)
                            / 2,
                            MVector3D(),
                            MVector2D(),
                            [],
                        ...
                        leg_center_bone = Bone(
                            "足中間",
                            "base of neck",
                            leg_center_vertex.position.copy(),
                            -1,
                            0,
                            0,
                            is_sizing=True,
                    ...
                    logger.debug_info(
                        ...
                        ", ".join(
                            [
                                f"{b.index:04d}-{b.parent_index:04d}[{b.name}]"
    ...
    def sort_bones(self, pmx, tmp_bones, tmp_bone_indexes, bone_index, is_ik, index):
        for bk, bv in tmp_bones.items():
            if bv.getIkFlag() == is_ik and (
                bv.parent_index == bone_index or bv.name not in pmx.bones
            ):
                index = self.regist_bone(
                    pmx, tmp_bones, tmp_bone_indexes, bk, is_ik, index + 1
                )
        return index

    def regist_bone(self, pmx, tmp_bones, tmp_bone_indexes, bone_name, is_ik, index):
        bv = tmp_bones[bone_name]
        index, parent_index = self.get_bone_parent(
            pmx, tmp_bones, tmp_bone_indexes, bv.parent_index, is_ik, index
        )
        ...
        logger.test(
            "regist_bone: %s, index: %s, parent: %s", bone_name, index, parent_index
        )

        return index

    def get_bone_parent(
        self, pmx, tmp_bones, tmp_bone_indexes, parent_index, is_ik, index
    ):
        if index <= 0:
    ...
    def read_RGB(self):
        return MVector3D(
            abs(self.read_float()), abs(self.read_float()), abs(self.read_float())
        )
    ...
    def define_read_vertex_idx(self, vertex_size):
        if vertex_size <= 2:
            ...
            raise MParseException(
                "define_read_vertex_idx 定義エラー {0}".format(vertex_size)
            )
