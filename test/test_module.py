...
class MMathTest(unittest.TestCase):
    ...
    def test_MQuaternion_rotationTo(self):
        ...
        new_to_v = MVector3D(
            3.8692103699906015, 17.718517382408315, -0.12363630515345259
        )
    ...
    def test_MQuaternion_inverted(self):
        parent_qq = MQuaternion.fromEulerAngles(
            4.444088972232067, -131.68893846184505, 6.602773293502102
        )
        from_orientation = MQuaternion.fromEulerAngles(
            -28.005875419210547, -34.26259576800703, -81.65247193883769
        )
        initial = MQuaternion.fromEulerAngles(-0.0, 90.0, -90.0)
        cancel_qq = MQuaternion(
            -0.9992778836743259,
            -0.037996199801564046,
    ...
    def test_MQuaternion_inverted02(self):
        initial = MQuaternion.fromEulerAngles(
            -23.093702434660457, 104.29537469962791, -100.75495862294058
        )
        orientation = MQuaternion.fromEulerAngles(
            2.8645534869583353, 112.98932633880118, -74.65035471978359
        )
